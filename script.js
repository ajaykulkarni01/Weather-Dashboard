const apiKey = "98f6f1e6b68c9d25e1012caa9c86475c";
...
function returnCurrentWeather(cityName) {
    ...
    $.get(queryURL).then(function(response){
        ...
        currWeatherDiv.html(`
        <h3>${response.name}, ${response.sys.country} (${currTime.getMonth()+1}/${currTime.getDate()}/${currTime.getFullYear()})<img src=${weatherIcon} height="70px"></h3>
            ...
            <div class="col-md">
                <div class="card text-white bg-primary">
                    <div class="card-body">
                        ...
                        <p>Wind: ${forecastInfo[i].wind.speed} m/s</p>
...
returnCurrentWeather("Adelaide");
returnWeatherForecast("Adelaide");
